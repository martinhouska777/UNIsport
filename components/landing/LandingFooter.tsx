      ...
      <div className="mx-auto flex max-w-[1280px] flex-col items-start justify-between gap-4 sm:flex-row sm:items-center">
        ...
        <div className="flex flex-col items-start gap-2 sm:items-end">
          ...
          <div className="flex items-center gap-4 font-mono text-[12px] tracking-wide">
            <Link href="/privacy" className="tap44 inline-block text-l-text-2 transition-colors hover:text-l-text">
              {footer.privacy}
            </Link>
            <span className="h-3 w-px bg-l-line" />
            <Link href="/terms" className="tap44 inline-block text-l-text-2 transition-colors hover:text-l-text">
              {footer.terms}
            </Link>
          </div>
