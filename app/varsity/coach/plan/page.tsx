...
/*
  ...
  screen's "Edit session" door. Without it the tab opens on the current block's
  current week. useSearchParams() needs a Suspense boundary or the production build
