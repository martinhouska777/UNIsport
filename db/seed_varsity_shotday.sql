...
--     AM · Hosea · 7:15am    — a straight four (4−), John Brown in 3 seat
--     PM · Kestrel · 4:30pm  — a coxless pair (2−), John Brown stroking
...
begin
  ...
  update public.varsity_lineups
     set boats = '[
           {"id":"boat-4am","badge":"4-","name":"Hosea","dock":"7:15am","oars":"Red set","note":"Two by twenty at rate 20. Full pressure off the second piece.","hasCox":false,"coxId":null,
  ...
  insert into public.varsity_lineups (day_key, boats, status, updated_at)
  values (pm_key, '[
           {"id":"boat-2pm","badge":"2-","name":"Kestrel","dock":"4:30pm","oars":"Blue set","note":"Steering practice — stay off the wall through the turn.","hasCox":false,"coxId":null,
