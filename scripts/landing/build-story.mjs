...
(function () {
  ...
  function playOars(f, delay) {
    ...
    // Out of the phone as ONE bundle first — visible, still stacked, just clear
    // of the phone — and only then apart into the arc. Coming straight to their
    // places read as appearing rather than spreading.
    setTimeout(function () {
      oars.forEach(function (o) {
        o.classList.remove("pre");
        o.style.translate = (o.__dx || 0) + "px " + ((o.__dy || 0) - 46) + "px";
        o.style.scale = "0.62";
      });
    }, delay || 0);
    ...
    setTimeout(function () {
      ...
      // Hand the oars back: with our class gone, their own transitions drive
      // the rotation again and it sweeps instead of snapping.
      setTimeout(function () {
